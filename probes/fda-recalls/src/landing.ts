...
:root {
	...
	--bad: #c4806f; --mono: ui-monospace, "SF Mono", SFMono-Regular, Menlo, Consolas, monospace;
}
...
.badge.critical { color: var(--bad); border-color: rgba(196, 128, 111, 0.5); }
.badge.major { color: var(--accent); border-color: rgba(210, 164, 76, 0.4); }
